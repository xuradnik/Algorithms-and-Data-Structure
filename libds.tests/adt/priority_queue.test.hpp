...
class PriorityQueueTests : public stest::CompositeTest {
public:
    PriorityQueueTests();
};


class UnosortedImplicitSequencePQTests : public stest::CompositeTest {
public:
    UnosortedImplicitSequencePQTests();
};


class UnosortedExplicitSequencePQTests : public stest::CompositeTest {
public:
    UnosortedExplicitSequencePQTests();
};


class SortedImplicitSequencePQTests : public stest::CompositeTest {
public:
    SortedImplicitSequencePQTests();
};


class SortedExplicitSequencePQTests : public stest::CompositeTest {
public:
    SortedExplicitSequencePQTests();
};


class TwoListsTests : public stest::CompositeTest {
public:
    TwoListsTests();
};


class BinaryHeapTests : public stest::CompositeTest {
public:
    BinaryHeapTests();
};
